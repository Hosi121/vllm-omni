...
All 60 pairings have a disposition. The timing tables below remain the 2026-09-22 measurements. The configuration matrix and affected per-cell reasons incorporate the [2026-09-23 scoped recovery runs](../../../e2e_recovery_20260923/README.md) and [CPU expansion](../../../e2e_expansion_20260923/README.md). The CPU expansion adds a separate 20-request serial MiniCPM-o text-to-speech profile; other new paths are single-request or short-stream runs. Profiling completion does not imply full release qualification.
...
| PC HX370 + RTX 5090 Laptop / Windows | profile completed | profile completed | NOT E2E | NOT E2E | synthetic policy pass |
