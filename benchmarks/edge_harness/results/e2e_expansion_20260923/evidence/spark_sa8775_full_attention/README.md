...
The [audit script](../../../../experiments/audit_spark_qualcomm_attention.py) reproduces the provenance and numerical checks using pinned source artifact paths in the S24 record. The [collector](../../../../experiments/collect_aihub_component.py) retrieves these existing jobs via the local client configuration; neither script contains credentials.
